...
def slice_foods():
    foods = ('carrot', 'cake', 'pie')
    last_two_foods = foods[-2:]  # Slice the tuple to get the last two elements
...
def hometown_info():
    ...
    home_town['city'] = 'Chicago'
    # print(home_town)

    home_town['state'] = 'Illinois'
    # print(home_town)

    home_town['population'] = 'nearly 3 mil'
    # print(home_town)
